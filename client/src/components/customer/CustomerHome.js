...
const CustomerHome = () => {
  ...
  const handlePlaceRecentOrder = async (event) => {
    const response = await axios.post(
      "https://se2024-j6qz.onrender.com/CustomerReOrder",
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const response = await axios.post(
          "https://se2024-j6qz.onrender.com/CustomerTopVendors"
        );
    ...
    const fetchLastOrder = async () => {
      try {
        const response = await axios.post(
          "https://se2024-j6qz.onrender.com/CustomerLastOrder",
          { clientEmail: sessionStorage.getItem("email") }
        );
    ...
    const fetchCalAndAmount = async () => {
      try {
        const response = await axios.post(
          "https://se2024-j6qz.onrender.com/CustomerCalAndAmount",
          { clientEmail: sessionStorage.getItem("email") }
        );
