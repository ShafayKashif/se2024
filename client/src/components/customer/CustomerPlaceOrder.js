...
const CustomerPlaceOrder = (props) => {
  ...
  const fetchVendorEmails = async (itemName) => {
    try {
      const response = await axios.post(
        `https://se2024-cwdv.onrender.com/get-vendor-emails-for-customer-place-order`,
        {
          query: itemName,
        }
      );
  ...
  const handleSearch = async (itemName) => {
    try {
      ...
      const response = await axios.post(
        `https://se2024-cwdv.onrender.com/items-for-search`,
        {
          query: itemName,
        }
      );
  ...
  const handleAddToCart = async (event) => {
    ...
    try {
      const itemId = itemID;
      const response = await axios.post(
        "https://se2024-cwdv.onrender.com/placeOrder",
        {
          vendor_email,
          customer_email,
          quantity,
  ...
  const handleSelfPickup = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://se2024-cwdv.onrender.com/selfpickup",
        {
          vendor_email,
          vendorname,
          customer_email,
  ...
  const handledelivery = async (event) => {
    ...
    try {
      console.log("price is: ", price);
      const response = await axios.post(
        "https://se2024-cwdv.onrender.com/customerDelivery",
        {
          vendor_email,
          vendorname,
          customer_email,
