...
const CustomerViewCart = () => {
  ...
  const handleSelfPickup = async (event) => {
    ...
    const response = await axios.get(
      "https://se2024-cwdv.onrender.com/CustomerCart"
    );
    ...
    for (let i = 0; i < numItems; i++) {
      ...
      try {
        const response = await axios.get(
          "https://se2024-cwdv.onrender.com/vendors"
        );
        if (response.status === 200) {
      ...
      try {
        const response = await axios.get(
          "https://se2024-cwdv.onrender.com/customers"
        );
        if (response.status === 200) {
      ...
      try {
        const response = await axios.get(
          "https://se2024-cwdv.onrender.com/items"
        );
        if (response.status === 200) {
      ...
      try {
        ...
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/selfpickupCart",
          {
            vendor_email,
            vendorname,
            customer_email,
      ...
      try {
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/UpdateQuantity",
          {
            itemId,
  ...
  const handledelivery = async (event) => {
    ...
    for (let i = 0; i < numItems; i++) {
      ...
      try {
        //   console.log("price is: ", price)
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/customerDeliveryCart",
          {
            vendor_email,
            vendorname,
            customer_email,
  ...
  const fetchItems = async () => {
    try {
      ...
      const response = await axios.post(
        "https://se2024-cwdv.onrender.com/CustomerViewCart",
  ...
  const handleRemoveItem = async (itemId) => {
    try {
      ...
      await axios.post("https://se2024-cwdv.onrender.com/UpdateQuantity", {
        itemId,
      ...
      await axios.post("https://se2024-cwdv.onrender.com/remove-from-cart", {
        itemId,
  ...
  const updateCartItems = async (updatedItems) => {
    try {
      // let customer_email = localStorage.getItem('CustomerEmail');
      const response = await axios.post(
        "https://se2024-cwdv.onrender.com/updateCartItems",
  ...
  return (
    <div className="maindiv">
      <h3 className="titleCVC">Your cart:</h3>
