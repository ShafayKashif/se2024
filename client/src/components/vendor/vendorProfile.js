  ...
  useEffect(() => {
    const fetchVendorDetails = async () => {
      try {
        ...
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/vendorDetails",
          { vendorEmail }
        );
    ...
    const fetchTotalOrders = async () => {
      try {
        // Fetch vendor details from backend
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/vendorAnalytics",
          { vendorEmail }
        );
    ...
    const fetchVendorOrderHistory = async () => {
      try {
        // Fetch vendor details from backend
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/VendorOrderHistory",
          { vendorEmail }
        );
    ...
    const numEachItemSold = async () => {
      try {
        // Fetch vendor details from backend
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/sellData",
          { vendorEmail }
        );
    ...
    const mostItemSold = async () => {
      try {
        // Fetch vendor details from backend
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/sellDataMostSold",
          { vendorEmail }
        );
    ...
    const fetchTotalRevenue = async () => {
      try {
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/calculateTotalRevenue",
          { vendorEmail }
        );
    ...
    const fetchItemGraphData = async () => {
      try {
        const response = await axios.post(
          "https://se2024-cwdv.onrender.com/vendorItemGraphData",
          { vendorEmail }
        );
